Задание 1
Улучшить базовый класс, добавив в него общий для всех метод log(), который выводит в консоль значение свойства id, а при его отсутствии значение свойства className.
